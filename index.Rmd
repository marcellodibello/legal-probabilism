...
goal of this evaluation? Is it to arrive at a probability that 
the defendant is guilty? We will see a few different probabilistic measures of the value of the evidence.
...
Once the evidence has been presented, a decision must be made. 
The law provides decision criteria in the form of standard of proofs, for example, convict only if the defendant's guilt was established beyond a reasonable doubt. Because these proof standard are not precise, probabilists have translated them in the more precise language of probability and statistics, but the usefulness of this translation remains controversial. Eliminating all reasonable doubts about someone's guilt seems to require more than establishing a high probability of guilt.
...
**Week 8: Eyewitness identifications**
...
and statistics to assess the value of eyewitness evidence. While some studies emphasizes its many pitfalls, more recent studies 
offers a more complicated picture. 
...
this testimony-centered approach. How to treat machine evidence, such as 
risk assessment and AI diagnostic tools, or software to interpret DNA evidence?
Should the existing approach be abandoned?
...
- Haack (2014), Legal Probabilism: An Epistemological Dissent - *Check canvas* 


## 10/31


**Week 11: The Story Model and Bayesian Networks**
...
**Week 12: Relative Plausibility**

*Primary readings*

- Pardo and Alle (2007), [Juridical proof and Inference and the Best Explanatiopn](https://sites.pitt.edu/~jdnorton/teaching/2682_confirmation/2021/slides/evidence_in_science/Pardo_Allen_2007.pdf)
...
- Steele and Stefansson (2021), [Belief Revision for Growing Awareness Get access Arrow](https://philarchive.org/rec/STEBRF-6)
