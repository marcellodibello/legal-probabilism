...
risk assessments, AI diagnostic tools, or software that interprets DNA evidence?
...
Legal cases often comprise multiple pieces of evidence, sometimes conflicting, presented by each side to advance their arguments. Can probability and statistics help to put them together, weigh their strengths and weaknesses, and yield a unified picture? This is where legal probabilism faces significant challenges.  
...
**Week 11: The story model**

An alternative to the probabilistic approach to evidence evaluation is the story model. According to this model, judges and jurors evaluate the evidence presented at trial not in a piecemeal manner, but holistically by constructing a unifying narrative or story of what happened.  Can probability theory model this holistic process? Bayesian networks have been used to calculate numerically the weight of complex bodies of evidence.  
...
Another alternative to the probabilistic approach is 
