...
Probability and statistical methods can be used in trial proceedings for assessing the strength 
of the evidence against the defendant, but can also lead to confusions, exaggerations and errors. To illustrate some of the problems, we will start by discussing an infamous case, People v. Collins (1968). This case started the law and probability 
debate in the United States back in the 70ies. Along the way, you will learn the basics of 
...
**Week 8: The Story Model and Bayesian Networks**
...
**Week 10: Probability, juries and decisions**
