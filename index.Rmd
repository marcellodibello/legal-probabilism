...
Legal probabilism is an ongoing research program that aims to harness the powers of probability theory to analyze, model and improve the evaluation of evidence and the process of decision-making in trial proceedings.  Many theorists have criticized it. These critiques range from difficulties in assessing the probability of someone’s criminal or civil liability to the dehumanization of trial decisions to misconstruing how the process of evidence evaluation and decision-making takes place in trial proceedings. To decide about a person’s life and liberty with numbers is irresponsible, even unjust. The seminar examines these current debates and their relevance to larger questions about AI and the human future. 
...
There is no textbook, but the following 
two can be useful resources:
...
**1**. Write a **critical essay** that outlines the main tenets of legal probabilism and some of the criticism 
that have been leveled against it. Your essay should begin with a careful summary of the key ideas of legal probabilism (1-2 pages). After that, you should apply the account to a toy example (1-2 pages). Finally, you should raise problems and difficulties for legal probabilism (1-2- pages). Please draw from the course readings as needed and demonstrate thoughtful engagement with them. 

**2**. After doing independent research, identify a disputed factual issue 
...
presented in the form of probabilities and statistics. This numerical presentation 
can lead to confusions, exaggerations and errors. To illustrate some of the problems, we will start by discussing an infamous case, People v. Collins (1968). This case started the law and probability 
...
match evidence works, and the debates about how it should be assessed and presented at trial. 
...
There is little doubt that match evidence should be used at trial as evidence of guilt, for example, when the defendant matches the crime traces. But what about evidence that people with certain traits are extremely like---based on the available data and studies---to a commit a crime? For example, data consistently shows people who committed burglaries in the past or a sexual offense are extremely like to re-offend. Can this evidence be used as evidence of guilt and if so how should it be evaluated?
...
the nurse is culpable for their death or was it a coincidence? 
...
**Week 5: Eyewitness identifications**

Eyewitness testimony is often a central piece in a 
...
and statistics to assess the value of eyewitness evidence and address questions such as, how reliable are reports by eyewitnesses? 
Does reliability increase with the subjective confidence of a witness? While some studies paint 
a rather negative picture about eyewitness evidence and its many pitfalls, more recent studies 
offers a more complicated picture. An eyewitness identification can be very strong evidence of guilt.
...
**Week 6: Probability of Guilt?**

We have seen how different types of evidence can be evaluated using probability and statistics. But what is the ultimate goal of this evaluation? Is it to arrive at a probability that the defendant is guilty?  
...
- Urbaniak and Di Bello (2021), Legal Probabilism, [Sec. 1](https://plato.stanford.edu/entries/legal-probabilism/#ProbTool)
...
Legal cases often comprise multiple pieces of evidence, sometimes conflicting, presented by each side to advance their arguments for or against the defendant. Can probability and statistics help to put them together, weigh their strengths and weaknesses and yield a unified picture? This is where legal probabilism faces significant challenges, both practical and theoretical.  
...
- Di Bello and Urbaniak

- Haack

## 10/17

**Week 9: The Story Model and Bayesian Networks**

A prominent alternative to the probabilistic approach to evidence evaluation is the story model. According to this model, judges and jurors evaluate the evidence presented at trial not in a piecemeal manner, but by constructing a unifying narrative or story of what happened.  Can probability theory model this holistic process of story construction? Bayesian networks have been used to calculate numerically the weight of large bodies of evidence. We are still far from a mature theory, but some progress has been made. 
...
**Week 10: Cross-examination**


When evidence is presented at trial, it will be scrutinized 
and tested against objections by both parties. The legal scholar Henry Wigmore regarded 
this cross-examination as "the greatest legal engine ever invented for the discovery of truth".
Cross-examination is directed at witness---so the live testimony of 
witnesses plays a central role. But new developments in technology have challenge 
this testimony-focus approach. How to treat machine evidence, such as 
a risk assessment tool, an AI diagnostic tool, or software to intepret DNA evidence?
...
**Week 11: Probability and decisions**

Once the evidence has been presented, evaluated and cross-examined, a decision must be made. 
Did the defendant commit the wrongdoing or not? The law provides decision criteria in the form of standard of proofs, for example, in criminal trial the standard is to convict the defendant only if guilt is established beyond a reasonable doubt. Because these legal standard are not precise, probabilists have translated them in the more precise language of probability and 
statistics, but this translation has remained controversial. Eliminating all reasonable doubts about someone's guilt seems to require more than just concluding that the defendant'a guilt is very probably.
...
**Week 12: Against legal probabilism**
